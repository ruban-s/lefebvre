    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal  aria-selected:opacity-100 hover:bg-blue-100 hover:textblue-500"
        ),
        day_range_end: "day-range-end ",
        day_selected:
          "bg-blue-900 text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
